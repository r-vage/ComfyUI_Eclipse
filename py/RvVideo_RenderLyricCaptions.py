        ...
        return io.Schema(
            ...
            inputs=[
                ...
                io.Float.Input("fade_in", default=0.5, min=0, max=2, step=0.01,
                               tooltip="Fade-in seconds; shortened automatically during rapid vocals."),
                io.Float.Input("fade_out", default=0.5, min=0, max=2, step=0.01,
                               tooltip="Fade-out seconds; outgoing line transitions are limited to 0.20 seconds."),
                io.Float.Input("min_display", default=0.7, min=0, max=3, step=0.01,
                               tooltip="Preferred display seconds. Fast words are grouped when possible; vocals always take priority."),
