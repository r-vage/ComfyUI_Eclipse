        ...
        return io.Schema(
            ...
            inputs=[
                io.Int.Input(
                    ...
                    max=100000,
                    step=1,
                    tooltip="Node ID to extract widget value from.",
                ),
                io.String.Input(
                    "widget_name",
                    multiline=False,
                    tooltip="Name of the widget to extract.",
                ),
                io.Boolean.Input(
                    "return_all",
                    default=False,
                    tooltip="Return all widget values as a formatted string.",
                ),
                ...
                io.String.Input(
                    ...
                    multiline=False,
                    optional=True,
                    tooltip="Node title to match instead of ID.",
                ),
                io.Int.Input(
    ...
    def execute(
        ...
        for node in workflow["nodes"]:
            if node_title:
                ...
                if (
                    node["type"] == "Widget to String [Eclipse]"
                    and node["id"] == int(unique_id)
                    and not link_id
                ):
