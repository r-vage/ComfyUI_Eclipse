...
from ..core.sml.model_files import ensure_model_path, verify_model_integrity, check_model_completeness
...
def _resolve_model_path(entry, quantization=None):
    ...
    if model_dir.exists():
        ...
        if is_complete:
            ...
            log.warning(_LOG_PREFIX, f"Model folder '{model_dir}' exists but is incomplete.")
    ...
    if "/" in repo_id:
        ...
        if alt_dir.exists():
            ...
            if is_complete:
                ...
                log.warning(_LOG_PREFIX, f"Model folder '{alt_dir}' exists but is incomplete.")
    ...
    if entry.get("family") == "Florence":
        ...
        if florence_dir.exists():
            ...
            if is_complete:
                ...
                log.warning(_LOG_PREFIX, f"Model folder '{florence_dir}' exists but is incomplete.")
