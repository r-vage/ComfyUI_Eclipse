...
class RvSettings_Sampler_Settings_NI_Seed_v21(io.ComfyNode):
    @classmethod
    def define_schema(cls):
        return io.Schema(
            node_id="Sampler Settings NI+Seed v2.1 [Eclipse]",
            display_name="⚠ Sampler Settings NI+Seed v2.1",
    ...
    def execute(cls, allow_overwrite: bool, sampler_name: str, scheduler: str, steps: int, cfg: float,
                ...
                upscale_steps: int, upscale_denoise: float,
