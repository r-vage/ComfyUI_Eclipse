...
class RvSettings_Sampler_Settings_Small_Seed(io.ComfyNode):
    @classmethod
    ...
    @classmethod
    def execute(cls, allow_overwrite: bool, sampler_name: Any, scheduler: Any, steps: int, cfg: float, seed: int = 0) -> io.NodeOutput:
