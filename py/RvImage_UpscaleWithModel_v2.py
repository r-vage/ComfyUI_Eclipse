...
class RvImage_UpscaleWithModel_v2(io.ComfyNode):
    ...
    def execute(
        ...
        resolution_steps = unwrap_value(resolution_steps, 8)
        sharpen_enabled = unwrap_value(sharpen_enabled, False)
        sharpen_amount = unwrap_value(sharpen_amount, 5.0)
        sharpen_ratio = unwrap_value(sharpen_ratio, 0.5)
        noise_radius = unwrap_value(noise_radius, 7)
        preserve_edges = unwrap_value(preserve_edges, 0.75)
