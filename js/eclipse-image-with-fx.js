/**
 * eclipse-image-with-fx.js — Image with FX dynamic widget visibility
 *
 * Visibility rules:
 ...
 *   background_image connected → show position, margin_x, margin_y
 *   background_image not connected → hide position, margin_x, margin_y
 *
...
const COLOR_WIDGETS = ['glow_inner_color', 'glow_outer_color', 'shadow_color'];
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, _app) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            vis.hideInitially([...GLOW_WIDGETS, ...SHADOW_WIDGETS, ...BG_WIDGETS]);
            ...
            const triggerWidgets = ['enable_glow', 'enable_shadow'];
