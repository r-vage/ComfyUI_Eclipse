/**
 * eclipse-load-batch-from-folder-advanced.js — Load Batch From Folder (Advanced) dynamic widget visibility
 *
 * Visibility rules:
...
const NODE_NAME = 'Load Batch From Folder (Advanced) [Eclipse]';

app.registerExtension({
    name: 'Eclipse.LoadBatchFromFolderAdvanced',
