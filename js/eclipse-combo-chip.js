...
const CHIP_COLOR_VARIABLES = {
    accent: '--eclipse-chip-accent',
    accentHover: '--eclipse-chip-accent-hover',
    accentBorder: '--eclipse-chip-accent-border',
    accentText: '--eclipse-chip-accent-text',
    trigger: '--eclipse-chip-trigger',
    triggerHover: '--eclipse-chip-trigger-hover',
};
...
.eclipse-${p}combo-trigger {
    ...
    padding: 0 10px;
    background: var(--eclipse-chip-trigger, #1a3324);
    border: 1px solid var(--eclipse-chip-accent, #2a5a3a);
    border-radius: 4px;
    color: #aaa;
    font-size: 0.75rem;
    font-family: sans-serif;
...
.eclipse-${p}combo-trigger:hover {
    border-color: var(--eclipse-chip-accent-border, #3a6a4a);
    background: var(--eclipse-chip-trigger-hover, #213d2c);
}
...
@keyframes eclipse-${p}chip-pulse {
    0%   { background: var(--eclipse-chip-accent, #2a5a3a); color: var(--eclipse-chip-accent-text, #f1f1f1); border-color: var(--eclipse-chip-accent-border, #4a8a5a); }
