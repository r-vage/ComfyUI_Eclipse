...
from transformers.image_utils import ImageInput, is_valid_image #type: ignore
...
class Florence2Processor(ProcessorMixin):
    ...
    def __call__(
        ...
        data_format: Optional["ChannelDimension"] = "channels_first",  # noqa: F821  #type: ignore
        input_data_format: Optional[
            Union[str, "ChannelDimension"]  # noqa: F821  #type: ignore
        ] = None,
